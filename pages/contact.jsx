...
import {DETAILS , CONTACTS } from '../constants/constants'
const Contact = () => {
        ...
        <BannerLayout>
            <div className=" px-4 py-2">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>{DETAILS.State}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className='md:text-base'>Postal code:</span>
                                <span className='text-LightGray md:text-sm'>{DETAILS.post}</span>
                            </div>
                        </div>
                ...
                <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700' href="https://github.com/Aparnap2/Aparnap2" target='_blank' rel="noreferrer"><FaGithub /></a>
                    ...
                    <a className='hover:scale-125 ease-in-out duration-700 hidden sm:block' href=" https://www.fiverr.com/aparnapradhan40?up_rollout=true" target='_blank' rel="noreferrer"><Fiverr_Icon /></a>
            ...
            >
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <a className='underline text-Snow' target='_blank' href='https://github.com/Aparnap2/Aparnap2'>Be the one to integrate this!</a>
                </div>
            </Modal>
            <Footer />
        </BannerLayout>
